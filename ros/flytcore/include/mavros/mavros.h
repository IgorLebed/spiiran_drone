 ...
 * @file mavros.h
 * @author Sharvashish Das <sharvashish@navstik.org>
 *
 * @addtogroup nodelib
 * @{
 ...
 */
/*
 * Copyright 2014,2015 Sharvashish Das.
 *
...
private:
	...
	std::unordered_map<mavlink::msgid_t, plugin::PluginBase::Subscriptions> plugin_subscriptions;
        ...
        //! GCS link -> router -> plugin handler
        std::unordered_map<mavlink::msgid_t, plugin::PluginBase::Subscriptions> plugin_gcs_subscriptions;
	...
	void plugin_route_cb(const mavlink::mavlink_message_t *mmsg, const mavconn::Framing framing);
        ...
        //! message router
        void plugin_gcs_route_cb(const mavlink::mavlink_message_t *mmsg, const mavconn::Framing framing);
