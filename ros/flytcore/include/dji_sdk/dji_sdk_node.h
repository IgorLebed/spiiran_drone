...
private:
  ...
  static void missionCallback(Vehicle* vehiclePtr, RecvContainer recvFrame,
                                  UserData userData);
  static void missionPushDataCallback(Vehicle* vehiclePtr, RecvContainer recvFrame,
                                  UserData userData);
...
private:
  ...
  ros::Publisher attitude_euler_ned_publisher;
  ros::Publisher attitude_quat_ned_publisher;
  ...
  ros::Publisher sdk_info_publisher;
