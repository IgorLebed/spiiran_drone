...
struct State_
{
  ...
  _mode_type mode;
   ...
   typedef uint8_t _mav_type_type;
  _mav_type_type mav_type;

   typedef uint8_t _mav_autopilot_type;
  _mav_autopilot_type mav_autopilot;

   typedef uint8_t _mav_sys_status_type;
  _mav_sys_status_type mav_sys_status;
...
struct MD5Sum< ::mavros_msgs::State_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xc3fa825e16d1350dULL;
  static const uint64_t static_value2 = 0x54cd9b4e0f09a9f7ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::mavros_msgs::State_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.mode);
      stream.next(m.mav_type);
      stream.next(m.mav_autopilot);
      stream.next(m.mav_sys_status);
    }
...
struct Printer< ::mavros_msgs::State_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mavros_msgs::State_<ContainerAllocator>& v)
  {
    ...
    s << indent << "mav_type: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.mav_type);
    s << indent << "mav_autopilot: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.mav_autopilot);
    s << indent << "mav_sys_status: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.mav_sys_status);
  }
};
