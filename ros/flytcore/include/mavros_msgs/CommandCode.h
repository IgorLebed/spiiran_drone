...
struct MD5Sum< ::mavros_msgs::CommandCode_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xfed90ec4390d621eULL;
  static const uint64_t static_value2 = 0x98c4fda7d4057f90ULL;
};
