...
class RCInMap {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float32(obj.channels, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.channels = _arrayDeserializer.float32(buffer, bufferOffset, null)
    return data;
  }
  ...
  static datatype() {
    ...
    return 'mavros_msgs/RCInMap';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '4039fa96f71dfdaad8b6946cc670fd98';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RCInMap(null);
