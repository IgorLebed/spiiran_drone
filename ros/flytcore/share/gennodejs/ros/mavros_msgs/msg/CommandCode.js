...
class CommandCode {
  ...
  static md5sum() {
    ...
    return 'fed90ec4390d621e98c4fda7d4057f90';
  }
  ...
  static messageDefinition() {
    ...
    uint16 CMD_DO_FLIGHTTERMINATION = 185
    uint16 CMD_DO_REPOSITION = 192
    uint16 CMD_DO_CONTROL_VIDEO = 200
    uint16 CMD_DO_SET_ROI = 201
    uint16 CMD_DO_MOUNT_CONFIGURE=204
    ...
    uint16 CMD_DO_MOTOR_TEST = 209
    uint16 CMD_DO_INVERTED_FLIGHT = 210
    uint16 CMD_DO_MOUNT_CONTROL_QUAT = 220
    uint16 CMD_PREFLIGHT_STORAGE = 245
    uint16 CMD_PREFLIGHT_REBOOT_SHUTDOWN = 246
    ...
    uint16 CMD_SET_MESSAGE_INTERVAL = 511
