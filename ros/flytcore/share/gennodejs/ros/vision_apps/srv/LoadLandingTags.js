...
class LoadLandingTagsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LoadLandingTagsRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LoadLandingTagsRequest
    let len;
    let data = new LoadLandingTagsRequest(null);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'vision_apps/LoadLandingTagsRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LoadLandingTagsRequest(null);
    return resolved;
    }
};

class LoadLandingTagsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LoadLandingTagsResponse
    ...
    bufferOffset = _arraySerializer.uint8(obj.tags_list, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LoadLandingTagsResponse
    let len;
    let data = new LoadLandingTagsResponse(null);
    ...
    data.tags_list = _arrayDeserializer.uint8(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += object.tags_list.length;
  ...
  static Resolve(msg) {
    ...
    const resolved = new LoadLandingTagsResponse(null);
...
module.exports = {
  Request: LoadLandingTagsRequest,
  Response: LoadLandingTagsResponse,
  md5sum() { return '45dcd6b83f8718a5041dfcd30a9d9f04'; },
  datatype() { return 'vision_apps/LoadLandingTags'; }
};
