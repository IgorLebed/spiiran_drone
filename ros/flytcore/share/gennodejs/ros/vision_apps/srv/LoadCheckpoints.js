...
class LoadCheckpointsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LoadCheckpointsRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LoadCheckpointsRequest
    let len;
    let data = new LoadCheckpointsRequest(null);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'vision_apps/LoadCheckpointsRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LoadCheckpointsRequest(null);
    return resolved;
    }
};

class LoadCheckpointsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LoadCheckpointsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LoadCheckpointsResponse
    let len;
    let data = new LoadCheckpointsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'vision_apps/LoadCheckpointsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LoadCheckpointsResponse(null);
...
module.exports = {
  Request: LoadCheckpointsRequest,
  Response: LoadCheckpointsResponse,
  md5sum() { return '0716ca053acdca4ffd9f1606f16f3814'; },
  datatype() { return 'vision_apps/LoadCheckpoints'; }
};
