...
let NavigationPosFeedback = require('./NavigationPosFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class NavigationPosActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new NavigationPosFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NavigationPosFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NavigationPosActionFeedback(null);
    ...
    data.feedback = NavigationPosFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigationPosActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = NavigationPosFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new NavigationPosFeedback()
    }
...
module.exports = NavigationPosActionFeedback;
