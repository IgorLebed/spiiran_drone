...
class ParamCreateRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ParamCreateRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ParamCreateRequest
    let len;
    let data = new ParamCreateRequest(null);
  ...
  static datatype() {
    ...
    return 'core_api/ParamCreateRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ParamCreateRequest(null);
...
class ParamCreateResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ParamCreateResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ParamCreateResponse
    let len;
    let data = new ParamCreateResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'core_api/ParamCreateResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ParamCreateResponse(null);
...
module.exports = {
  ...
  Response: ParamCreateResponse,
  md5sum() { return '3139407759ce2a5b88c5244e2a57e352'; },
  datatype() { return 'core_api/ParamCreate'; }
};
