...
if("FALSE" STREQUAL "TRUE")
  set(dji_sdk_SOURCE_PREFIX /home/flytpod/flytos/src/flytOS/flyt_core/core_nodes/dji/dji_sdk)
  set(dji_sdk_DEVEL_PREFIX /home/flytpod/flytos/amd64-devel)
  set(dji_sdk_INSTALL_PREFIX "")
  set(dji_sdk_PREFIX ${dji_sdk_DEVEL_PREFIX})
else()
  set(dji_sdk_SOURCE_PREFIX "")
  set(dji_sdk_DEVEL_PREFIX "")
  set(dji_sdk_INSTALL_PREFIX /flyt/flytos/flytcore)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dji_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/flyt/flytos/flytcore/${idir}'.  ${_report}")
    endif()
...
set(depends "message_runtime;geometry_msgs;nav_msgs;std_msgs;djiosdk")
