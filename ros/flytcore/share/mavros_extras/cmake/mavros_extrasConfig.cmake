...
if("FALSE" STREQUAL "TRUE")
  set(mavros_extras_SOURCE_PREFIX /home/flytpod/flytos/src/flytOS/flyt_core/core_nodes/mavros/mavros_extras)
  set(mavros_extras_DEVEL_PREFIX /home/flytpod/flytos/amd64-devel)
  ...
  set(mavros_extras_INSTALL_PREFIX /flyt/flytos/flytcore)
...
if(NOT "/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros_extras' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/flyt/flytos/flytcore/${idir}'.  ${_report}")
    endif()
