...
if("FALSE" STREQUAL "TRUE")
  set(async_web_server_cpp_SOURCE_PREFIX /home/flytpod/flytos/src/flytOS/flyt_packages/vision/dependencies/async_web_server_cpp)
  set(async_web_server_cpp_DEVEL_PREFIX /home/flytpod/flytos/amd64-devel)
  ...
  set(async_web_server_cpp_INSTALL_PREFIX /flyt/flytos/flytcore)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'async_web_server_cpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/flyt/flytos/flytcore/${idir}'.  ${_report}")
    endif()
