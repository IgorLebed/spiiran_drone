...
if("FALSE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /home/flytpod/flytos/src/flytOS/flyt_core/core_nodes/mavros/mavros)
  set(mavros_DEVEL_PREFIX /home/flytpod/flytos/amd64-devel)
  set(mavros_INSTALL_PREFIX "")
  set(mavros_PREFIX ${mavros_DEVEL_PREFIX})
else()
  set(mavros_SOURCE_PREFIX "")
  set(mavros_DEVEL_PREFIX "")
  set(mavros_INSTALL_PREFIX /flyt/flytos/flytcore)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/flyt/flytos/flytcore/${idir}'.  ${_report}")
    endif()
