...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CommandCode>)))
  ...
  "fed90ec4390d621e98c4fda7d4057f90")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CommandCode)))
  "Returns md5sum for a message object of type 'CommandCode"
  "fed90ec4390d621e98c4fda7d4057f90")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CommandCode>)))
  ...
  (cl:format cl:nil "# Some MAV_CMD command codes.~%# Actual meaning and params you may find in MAVLink documentation~%# http://mavlink.org/messages/common#ENUM_MAV_CMD~%~%# some common MAV_CMD~%uint16 CMD_CONDITION_YAW=115~%uint16 CMD_DO_SET_MODE = 176~%uint16 CMD_DO_JUMP = 177~%uint16 CMD_DO_CHANGE_SPEED = 178~%uint16 CMD_DO_SET_HOME = 179~%uint16 CMD_DO_SET_RELAY = 181~%uint16 CMD_DO_REPEAT_RELAY = 182~%uint16 CMD_DO_SET_SERVO = 183~%uint16 CMD_DO_REPEAT_SERVO = 184~%uint16 CMD_DO_FLIGHTTERMINATION = 185~%uint16 CMD_DO_REPOSITION = 192~%uint16 CMD_DO_CONTROL_VIDEO = 200~%uint16 CMD_DO_SET_ROI = 201~%uint16 CMD_DO_MOUNT_CONFIGURE=204~%uint16 CMD_DO_MOUNT_CONTROL = 205~%uint16 CMD_DO_SET_CAM_TRIGG_DIST = 206~%uint16 CMD_DO_FENCE_ENABLE = 207~%uint16 CMD_DO_PARACHUTE = 208~%uint16 CMD_DO_MOTOR_TEST = 209~%uint16 CMD_DO_INVERTED_FLIGHT = 210~%uint16 CMD_DO_MOUNT_CONTROL_QUAT = 220~%uint16 CMD_PREFLIGHT_STORAGE = 245~%uint16 CMD_PREFLIGHT_REBOOT_SHUTDOWN = 246~%uint16 CMD_PREFLIGHT_CALIBRATION = 241~%uint16 CMD_MISSION_START = 300~%uint16 CMD_COMPONENT_ARM_DISARM = 400~%uint16 CMD_GET_HOME_POSITION=410~%uint16 CMD_START_RX_PAIR = 500~%uint16 CMD_SET_MESSAGE_INTERVAL = 511~%uint16 CMD_REQUEST_AUTOPILOT_CAPABILITIES = 520~%uint16 CMD_DO_TRIGGER_CONTROL = 2003~%~%# Waypoint related commands~%uint16 NAV_WAYPOINT = 16~%uint16 NAV_LOITER_UNLIM = 17~%uint16 NAV_LOITER_TURNS = 18~%uint16 NAV_LOITER_TIME = 19~%uint16 NAV_RETURN_TO_LAUNCH = 20~%uint16 NAV_LAND = 21~%uint16 NAV_TAKEOFF = 22~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CommandCode)))
  "Returns full string definition for message of type 'CommandCode"
  (cl:format cl:nil "# Some MAV_CMD command codes.~%# Actual meaning and params you may find in MAVLink documentation~%# http://mavlink.org/messages/common#ENUM_MAV_CMD~%~%# some common MAV_CMD~%uint16 CMD_CONDITION_YAW=115~%uint16 CMD_DO_SET_MODE = 176~%uint16 CMD_DO_JUMP = 177~%uint16 CMD_DO_CHANGE_SPEED = 178~%uint16 CMD_DO_SET_HOME = 179~%uint16 CMD_DO_SET_RELAY = 181~%uint16 CMD_DO_REPEAT_RELAY = 182~%uint16 CMD_DO_SET_SERVO = 183~%uint16 CMD_DO_REPEAT_SERVO = 184~%uint16 CMD_DO_FLIGHTTERMINATION = 185~%uint16 CMD_DO_REPOSITION = 192~%uint16 CMD_DO_CONTROL_VIDEO = 200~%uint16 CMD_DO_SET_ROI = 201~%uint16 CMD_DO_MOUNT_CONFIGURE=204~%uint16 CMD_DO_MOUNT_CONTROL = 205~%uint16 CMD_DO_SET_CAM_TRIGG_DIST = 206~%uint16 CMD_DO_FENCE_ENABLE = 207~%uint16 CMD_DO_PARACHUTE = 208~%uint16 CMD_DO_MOTOR_TEST = 209~%uint16 CMD_DO_INVERTED_FLIGHT = 210~%uint16 CMD_DO_MOUNT_CONTROL_QUAT = 220~%uint16 CMD_PREFLIGHT_STORAGE = 245~%uint16 CMD_PREFLIGHT_REBOOT_SHUTDOWN = 246~%uint16 CMD_PREFLIGHT_CALIBRATION = 241~%uint16 CMD_MISSION_START = 300~%uint16 CMD_COMPONENT_ARM_DISARM = 400~%uint16 CMD_GET_HOME_POSITION=410~%uint16 CMD_START_RX_PAIR = 500~%uint16 CMD_SET_MESSAGE_INTERVAL = 511~%uint16 CMD_REQUEST_AUTOPILOT_CAPABILITIES = 520~%uint16 CMD_DO_TRIGGER_CONTROL = 2003~%~%# Waypoint related commands~%uint16 NAV_WAYPOINT = 16~%uint16 NAV_LOITER_UNLIM = 17~%uint16 NAV_LOITER_TURNS = 18~%uint16 NAV_LOITER_TIME = 19~%uint16 NAV_RETURN_TO_LAUNCH = 20~%uint16 NAV_LAND = 21~%uint16 NAV_TAKEOFF = 22~%~%~%~%"))
