...
(defsystem "mavros_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "GPSGlobalOrigin" :depends-on ("_package_GPSGlobalOrigin"))
    (:file "_package_GPSGlobalOrigin" :depends-on ("_package"))
    ...
    (:file "LogDownloadStatus" :depends-on ("_package_LogDownloadStatus"))
    (:file "_package_LogDownloadStatus" :depends-on ("_package"))
    (:file "LogList" :depends-on ("_package_LogList"))
    (:file "_package_LogList" :depends-on ("_package"))
    ...
    (:file "RCInMap" :depends-on ("_package_RCInMap"))
    (:file "_package_RCInMap" :depends-on ("_package"))
    ...
    (:file "VisionPoseDelta" :depends-on ("_package_VisionPoseDelta"))
    (:file "_package_VisionPoseDelta" :depends-on ("_package"))
